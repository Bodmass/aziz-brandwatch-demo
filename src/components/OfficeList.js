...
const OFFICES = [
  {
    ...
    url: 'http://api.openweathermap.org/data/2.5/weather?q=brighton'
  },
  {
    name: 'New York',
    flag: 'us',
    ...
    url: 'http://api.openweathermap.org/data/2.5/weather?id=5128581'
  },
  {
    name: 'Boston',
    flag: 'us',
    ...
    url: 'http://api.openweathermap.org/data/2.5/weather?id=4930956'
  },
  {
    name: 'London',
    flag: 'gb',
    ...
    url: 'http://api.openweathermap.org/data/2.5/weather?id=2643743'
  },
  {
    name: 'Madrid',
    flag: 'es',
  ...
  },
  {
    ...
    url: 'http://api.openweathermap.org/data/2.5/weather?id=2988507'
  },
  {
    name: 'Stuttgart',
    flag: 'de',
    ...
    url: 'http://api.openweathermap.org/data/2.5/weather?id=2825297'
  },
  {
    name: 'Berlin',
    flag: 'de',
  ...
  },
  {
    ...
    url: 'http://api.openweathermap.org/data/2.5/weather?id=1880252'
  },
  {
    name: 'Sydney',
    flag: 'au',
    ...
    url: 'http://api.openweathermap.org/data/2.5/weather?id=2147714'
  }
]
const OfficeList = () => {
  return (
